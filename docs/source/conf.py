...
latex_documents = [
    (master_doc, "zarrtraj.tex", "zarrtraj Documentation",
     "zarrtraj", "manual"),
]
...
man_pages = [
    (master_doc, "zarrtraj", "zarrtraj Documentation",
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, "zarrtraj", "zarrtraj Documentation",
     author, "zarrtraj", "This is a kit that provides the ability to read and write trajectory data in the Zarr file format",
     "Miscellaneous"),
]
